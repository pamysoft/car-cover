            ...
            <div className="rv-collapse group py-[3px]">
                ...
                <div className="mt-[8px] hidden group-[.is-active]:block">
                    <div className="[&>h2]:text-[18px] [&>h2]:mb-[10px]">
                        ...
                        <p>Once you've placed your order, we'll send you an email confirmation with the carrier details and tracking number.</p></div>
                </div>
            </div>
            <div className="rv-collapse group py-[3px]">
                ...
                <div className="mt-[8px] hidden group-[.is-active]:block">
                    <div className="[&>h2]:text-[18px] [&>h2]:mb-[10px]">
                        ...
                        <p>You can find additional information about our Warranty Policy in our <a href="/terms-and-conditions#Warranty-Policy-Conditions">Terms and Conditions</a>.</p></div>
                </div>
                <div className="rv-collapse group py-[3px]">
                    ...
                    <div className="mt-[8px] hidden group-[.is-active]:block">
                        <div className="[&>h2]:text-[18px] [&>h2]:mb-[10px]">
                            ...
                            <center><img src="/media/cable-lock-installation.jpg" alt="Cable Lock Installation" /></center>
                            <hr />
